...
const sections: HelpSection[] = [
  ...
  },
  {
    id: 'tagging',
    title: 'タグ付け（コードウィンドウ）',
    summary: 'アクション記録とラベル付け、ホットキー操作',
    steps: [
      'メイン画面右側のコードウィンドウでボタンを押すと録画開始/終了。同時に複数アクションを記録できます。',
      'ラベルグループを選択してから記録すると labels に保存されます。色/サイズ/リンク、レイアウトは 設定 > コードウィンドウ で編集できます。',
      'ホットキーは 設定 > ホットキー でアクションごとに設定（2チーム目は Shift+同じキー）。頻用アクションはショートカット化すると効率的です。',
    ],
  },
  {
    id: 'timeline',
  ...
  },
  {
    id: 'settings',
    title: '設定とプリセット管理',
    summary: 'テーマ・オーバーレイ・アクションプリセット・ホットキー・コードレイアウト',
    steps: [
      'メニューの「設定...」または Cmd/Ctrl + , で開きます（未保存検知あり）。',
      '一般: テーマ（ライト/ダーク/システム）、クリップオーバーレイの表示項目・テンプレートを編集できます。',
      'アクションプリセット: 追加/編集/削除、インポート/エクスポート（重複IDは自動リネーム）。ホットキー編集、コードウィンドウレイアウトの作成・編集もここで行います。',
    ],
  },
  {
    id: 'shortcuts',
