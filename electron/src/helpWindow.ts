...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      '分析ウィンドウのエクスポートメニューでは、Copy structured summary / Snapshot PNG（現在タブ全内容）/ Analysis PDF（全内容: dashboard・momentum・matrix）を実行できます。',
      'クロス集計タブでは、現在の軸・フィルタ状態を反映したCSV / XLSXエクスポートが可能です。',
  ...
  },
  {
    ...
    title: '設定とコードウィンドウ管理',
    summary:
      'テーマ・オーバーレイ・ホットキー・コードウィンドウ（レイアウト/ホットキー）の編集',
    steps: [
