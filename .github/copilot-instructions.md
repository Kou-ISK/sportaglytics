...
7. 仕様・設計・ユーザー影響・開発手順・配置判断が変わる場合は `docs/documentation-guide.md` の Docs Impact Matrix に従って docs を同時更新する。
8. ドキュメントを追加する場合は `docs/README.md` と `docs/documentation-guide.md` を確認する。
