...
type AIAnalysisTabControllerState = ReturnType<typeof useAIAnalysisTabController>;

interface AIAnalysisTabViewProps extends AIAnalysisTabControllerState {
  hasData: boolean;
