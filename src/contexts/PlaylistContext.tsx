...
import type { Playlist, PlaylistItem, PlaylistState } from '../types/Playlist';
import type { TimelineData } from '../types/TimelineData';
import { usePlaylistStateActions } from './playlist/usePlaylistStateActions';
import { usePlaylistWindowBridge } from './playlist/usePlaylistWindowBridge';
import type { PlayItemCallback, SeekCallback } from './playlist/types';
...
export const PlaylistProvider: React.FC<PlaylistProviderProps> = ({
  ...
  const { openPlaylistWindow, syncToWindow } = usePlaylistWindowBridge({
    state,
    isWindowOpen,
    setIsWindowOpen,
    setState,
